    ...
    <div class="container px-6 pt-6">
      ...
      <div class="mb-6 flex justify-center">
        <ul class="text-left">
          ...
          <li class="flex flex-col flex-wrap">
            <b class="mr-1">Vercel</b>
            <a class="truncate" href="https://vercel.com/" target="_blank">
              https://vercel.com/
            </a>
          </li>
          <li class="flex flex-col flex-wrap">
            <b class="mr-1">Supabase</b>
            <a class="truncate" href="https://supabase.com/" target="_blank">
              https://supabase.com/
            </a>
          </li>
        </ul>
